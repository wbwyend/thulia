    ...
    <div>
        <el-container style="width: 1024px; margin: auto;">
                ...
                <el-container style="width: 100%; height: 700px;">
                    <el-menu default-active="$route.path" router style="width: 100%;">
                        ...
                        <el-submenu index="/space/shop/sale">
                            ...
                            <el-menu-item index="/space/shop/goods">
                                <i class="el-icon-sell"></i>
                                <span>在售商品</span>
                            </el-menu-item>
                            <el-menu-item index="/space/shop/goods/outsale">
                                <i class="el-icon-sold-out"></i>
                                <span>下架商品</span>
                            </el-menu-item>
                        </el-submenu>
                        <el-submenu index="/space/shop/report">
                            <template slot="title">
                                <i class="el-icon-s-order"></i>
                                <span>数据报表</span>
                            </template>
                            <el-menu-item index="/space/shop/report/browse">
            ...
            <el-main style="padding: 0;">
                ...
                <el-container style="width: 100%; max-height: 80vh;">
