...
export default {
    ...
    mounted() {
        this.$request.post('/goods/get/outsale/saler', this.saler.id).then(res => {
            if (res.code === '200') {
    ...
    methods: {
        ...
        handlePictureSuccess(response, file, fileList) {
            ...
            // var elementNode = xmlDoc.getElementsByTagName('data')[0];
            // var nodeValue = elementNode.childNodes[0].nodeValue;
